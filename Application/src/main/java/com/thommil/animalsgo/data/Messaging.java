...
public class Messaging {
    ...
    // RENDERER
    public static final int CHANGE_PREVIEW_SIZE = 0x0010;
    public static final int CHANGE_PREVIEW_PLUGIN = 0x0020;
    public static final int CHANGE_CAPTURE = 0x0040;
    public static final int CHANGE_ZOOM = 0x0080;
    public static final int CAPTURE_NEXT_FRAME = 0x0100;
