...
public class UIBasic extends UIPlugin {

    private static final String TAG = "A_GO/Plugin/UIBasic";

    private static final String ID = "ui_basic";
    ...
    public String getName() {
        return this.mContext.getString(R.string.plugins_ui_basic_name);
    }

    @Override
    public String getSummary() {
        return mContext.getString(R.string.plugins_ui_basic_summary);
    }
